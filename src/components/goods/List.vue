  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="goodslist" border stripe>
        ...
        <el-table-column label="创建事件" prop="add_time" width="170px">
        ...
        <el-table-column label="操作" width="130px">
          <template v-slot="scope">
            ...
            <el-button type="danger" icon="el-icon-delete" size="small" @click="removeGoodById(scope.row.goods_id)"></el-button>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    async removeGoodById(id) {
      ...
      if (res.meta.status !== 200) return this.$message('删除商品失败')
